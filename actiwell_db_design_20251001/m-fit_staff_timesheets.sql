...
CREATE TABLE `staff_timesheets` (
  ...
  `day_type` smallint unsigned NOT NULL DEFAULT '1' COMMENT '1 - working day, 2 - day off',
  `device_id` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `staff_timesheets_staff_id_foreign` (`staff_id`),
  CONSTRAINT `staff_timesheets_staff_id_foreign` FOREIGN KEY (`staff_id`) REFERENCES `staffs` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2025-10-01  8:43:07
