...
--
-- Table structure for table `policy_tiers`
--

DROP TABLE IF EXISTS `policy_tiers`;
...
CREATE TABLE `policy_tiers` (
  ...
  `commission_kind` smallint NOT NULL,
  `commission_value` decimal(15,2) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `policy_tiers_policy_id_foreign` (`policy_id`),
  CONSTRAINT `policy_tiers_policy_id_foreign` FOREIGN KEY (`policy_id`) REFERENCES `policies` (`id`) ON DELETE SET NULL
...
-- Dump completed on 2025-10-01  8:41:52
