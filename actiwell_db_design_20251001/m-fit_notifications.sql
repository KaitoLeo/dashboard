...
CREATE TABLE `notifications` (
  ...
  PRIMARY KEY (`id`),
  KEY `notifications_operator_id_foreign` (`operator_id`),
  CONSTRAINT `notifications_operator_id_foreign` FOREIGN KEY (`operator_id`) REFERENCES `operators` (`id`)
...
-- Dump completed on 2025-10-01  8:42:55
