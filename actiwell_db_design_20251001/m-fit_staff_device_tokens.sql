...
--
-- Table structure for table `staff_device_tokens`
--

DROP TABLE IF EXISTS `staff_device_tokens`;
...
CREATE TABLE `staff_device_tokens` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `staff_device_tokens_staff_id_unique` (`staff_id`),
  CONSTRAINT `staff_device_tokens_staff_id_foreign` FOREIGN KEY (`staff_id`) REFERENCES `staffs` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2025-10-01  8:42:27
