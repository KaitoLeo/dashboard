...
CREATE TABLE `departments` (
  ...
  PRIMARY KEY (`id`),
  KEY `departments_upper_id_foreign` (`upper_id`),
  KEY `departments_operator_id_foreign` (`operator_id`),
  ...
  CONSTRAINT `departments_operator_id_foreign` FOREIGN KEY (`operator_id`) REFERENCES `operators` (`id`) ON DELETE CASCADE,
  CONSTRAINT `departments_upper_id_foreign` FOREIGN KEY (`upper_id`) REFERENCES `departments` (`id`) ON DELETE SET NULL
...
-- Dump completed on 2025-10-01  8:43:25
