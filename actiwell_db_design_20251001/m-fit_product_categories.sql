...
CREATE TABLE `product_categories` (
  ...
  `product_category_number` bigint NOT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `product_categories_operator_id_index` (`operator_id`),
  KEY `product_categories_creator_id_index` (`creator_id`)
...
-- Dump completed on 2025-10-01  8:40:20
