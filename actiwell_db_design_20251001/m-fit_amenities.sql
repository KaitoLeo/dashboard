...
CREATE TABLE `amenities` (
  ...
  `type` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'general | parking | others',
  `name` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL,
  `admin_icon` text COLLATE utf8mb4_unicode_ci,
...
-- Dump completed on 2025-10-01  8:42:32
