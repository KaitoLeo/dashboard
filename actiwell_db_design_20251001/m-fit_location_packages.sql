...
--
-- Table structure for table `location_packages`
--

DROP TABLE IF EXISTS `location_packages`;
...
CREATE TABLE `location_packages` (
  ...
  PRIMARY KEY (`id`),
  KEY `location_packages_package_id_index` (`package_id`)
...
-- Dump completed on 2025-10-01  8:41:01
