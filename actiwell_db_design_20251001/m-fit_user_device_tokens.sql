...
CREATE TABLE `user_device_tokens` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `user_device_tokens_user_id_unique` (`user_id`),
  CONSTRAINT `user_device_tokens_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2025-10-01  8:41:44
