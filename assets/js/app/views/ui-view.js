    ...
    container.innerHTML = `
            <div class="d-flex align-items-center justify-content-center h-100">
                <div class="text-center">
                    ...
                    <p class="text-muted mt-2">Äang táº£i biá»ƒu Ä‘á»“...</p>
                </div>
            </div>
        `;
      ...
      container.innerHTML = `
                <div class="d-flex align-items-center justify-content-center h-100">
                    <div class="text-center">
                        ...
                        <p class="text-muted mt-2">Biá»ƒu Ä‘á»“ sáº½ Ä‘Æ°á»£c hiá»ƒn thá»‹ á»Ÿ Ä‘Ã¢y</p>
                    </div>
                </div>
            `;
    }, 2000);
...
window.App.views.ui = { initAll, toggleSidebar, showNotification, initCharts, initTables, initForms };
