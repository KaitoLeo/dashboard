...
App.state.currentSection = currentSection;
let currentFilters = {
...
App.state.filters = currentFilters;

// Initialize Lambda integration
let lambdaIntegration = null;
App.state.lambdaIntegration = lambdaIntegration;
...
App.models.databaseAnalytics = DatabaseAnalytics;
...
App.controllers.dashboard = {
  initialize: window.initializeApp,
  ...
  getVietnamTime: window.getVietnamTime,
};
